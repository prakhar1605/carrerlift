...
export class VirtualScroll {
  constructor(container, options = {}) {
    ...
    this.wrapper.style.cssText = 'position:relative;width:100%;grid-column:1/-1;';
    ...
    // Render area — 2 column grid matching parent
    this.renderArea = document.createElement('div');
    this.renderArea.style.cssText = 'position:relative;will-change:transform;display:grid;gap:14px;';
    this.renderArea.className = 'vs-render-area';
